...
<?php echo form_open_multipart('admin/proses_edit_halaman/'.$halaman->id_halaman);?>
                <form method="post" action="<?php echo base_url(); ?>Admin/halaman_file<?= $halaman->id_halaman ?>" name="kirimanlur" enctype="multipart/form-data">  
  ...
  <div class="col-md-12">
    <div class="box-header">
      ...
      <div class="form-group">
        ...
        <input type="text" class="form-control" id="jdlPost" placeholder="Judul Halaman" name="judul" value="<?= $halaman->judul_hlm ?>">
      </div>
      ...
      <br>
      <br/>
      <input type="hidden" name="berkas_lama" value="<?= $halaman->berkas ?>">
